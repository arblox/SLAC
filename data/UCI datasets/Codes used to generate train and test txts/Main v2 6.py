...
#1.1 Load
filepath = os.path.expanduser(os.path.expanduser("~/Documents/2 Oxford/Uni/DPhil/Codes/Uncertainty bounds/PowerPlant")) 
data_file = os.path.join(filepath, "PowerPlant.txt")
...
t = time.time()
modelLip.train(method='POKI',losstype=Lip_losstype, optimizer = 'Scipy', maxevals = maxevals, cv = 1)  #Lip_method
...
eval_results = {
    'GP': 'n too large',#eval_GP(modelGP,X_test,Y_test),
