...
#1.1 Load
filepath = os.path.expanduser(os.path.expanduser("~/Documents/2 Oxford/Uni/DPhil/Codes/Uncertainty bounds/Concrete strength")) 
data_file = os.path.join(filepath, "data.txt")
...
t = time.time()
modelLip.train(method='LACKI',losstype=Lip_losstype, optimizer = 'Shubert', maxevals = maxevals, cv = 100)  #Lip_method
