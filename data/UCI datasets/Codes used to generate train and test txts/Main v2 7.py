...
#1.1 Load
filepath = os.path.expanduser(os.path.expanduser("~/Documents/2 Oxford/Uni/DPhil/Codes/Uncertainty bounds/Protein")) 
data_file = os.path.join(filepath, "protein.txt")
