...
#1.1 Load
filepath = os.path.expanduser(os.path.expanduser("~/Documents/2 Oxford/Uni/DPhil/Codes/Uncertainty bounds/BostonHousing")) 
data_file = os.path.join(filepath, "BostonHousing.txt")
